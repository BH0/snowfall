...
* Ensure form doesn't interrupt user experience (too badly) - done
*/
...
var formParent = document.getElementsByTagName('div')[0];
var formSection = formParent.appendChild(form);

formParent.addEventListener("mouseover", function(e) {
    formSection.style.cssText = "visibility:visible;";
});
formSection.addEventListener("mouseleave", function(e) {
